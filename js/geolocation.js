...
function success(position) {
    ...
    statusMsg.textContent = "Position found!"
    // STEP 3c: Output the latitude and longitude coordinates to the <dd> 
    //elements in steps 1a and 1b
    latitude.textContent = position.coords.latitude + "º";
    longitude.textContent = position.coords.longitude + "º";
    ...
    mapLink.textContent = "Open to map";
}   
